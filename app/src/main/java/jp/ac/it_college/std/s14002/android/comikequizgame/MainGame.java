...
public class MainGame extends AppCompatActivity {
    ...
    private void setQuestion() {
        ...
        String sql = "SELECT Pref, City0, City1, City2, City3, City4 FROM MyTable WHERE _id=" + questionList.get(0);
    ...
    public void onClick(View v) {
        ...
        if (Integer.parseInt(QuestionNo) == 10) {
            stageClear();
        }
            setQuestion();
